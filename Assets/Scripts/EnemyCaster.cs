...
public class EnemyCaster : Enemy
{
	...
	public void Cast()
	{
		...
		{
			var proj = Instantiate(CastProjectile, HitCast.transform.position, Quaternion.LookRotation(Vector3.up), GameManager.Instance.Game.transform).GetComponent<Fireball>();
			proj.Target = Target;
		}
